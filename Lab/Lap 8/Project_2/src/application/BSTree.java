...
public class BSTree<T extends Comparable<T>> {
	...
	private QStack<T> nextStack = new QStack<>();
	private QStack<T> prefStack = new QStack<>();
	public BSTree() {
		root = null;
	}
	...
	public QStack<T> getNextStack() {
		return nextStack;
	}

	public void setNextStack(QStack<T> nextStack) {
		this.nextStack = nextStack;
	}

	public QStack<T> getPrefStack() {
		return prefStack;
	}

	public void setPrefStack(QStack<T> prefStack) {
	...
	public T getNext() {
		...
		Node<T> node = new Node<>(nextStack.pop());
	...
	public T getPref() {
		...
		Node<T> node = new Node<>(prefStack.pop());
